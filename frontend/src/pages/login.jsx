...
import LoginImg from "../assets/signin.gif";
        ...
        <div className="bg-white p-2 py-4 w-full max-w-lg mx-auto rounded-md ">
          ...
          <form className="pt-6 px-2 flex flex-col" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <Link to={"ForgetPassword"} className="block w-fit ml-auto  hover:underline hover:text-blue-400"> Forget Password</Link>
            </div>
            <button className="bg-blue-500  text-white px-1 py-1 mt-4 w-full rounded-md hover:bg-blue-600 hover:scale-100">
              Login
            </button>
          </form>
          <div className="mt-2">
          <p>Don't have account?<Link to={"/Signup"} className="text-blue-400 hover:text-blue-700"> Signup</Link></p>
          </div>
        </div>
      </div>
    </section>
